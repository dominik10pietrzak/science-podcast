...
export const getPodcastDetails =
  (id: number): ThunkAction<void, RootStateOrAny, undefined, Action> =>
  async (dispatch) => {
    try {
...
export const createPodcastComment =
  (
    podcastId: number,
    comment: string
  ): ThunkAction<void, RootStateOrAny, undefined, Action> =>
...
export const updatePodcast =
  (podcast: any): ThunkAction<void, RootStateOrAny, undefined, Action> =>
  async (dispatch, getState) => {
    try {
      dispatch({
